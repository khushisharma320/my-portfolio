        ...
        <div name="About" className="w-full h-screen  text-white text-center lg:pb-40">
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center px-4 lg:flex-row lg:pb-40">
                ...
                <div className="flex flex-col justify-center" data-aos="fade-down">
                    ...
                    <p className="px-10 pb-8">I am an experienced System Engineer with 1 year and 4 months of
                    ...
                    <a className="hidden lg:block uppercase text-yellow-700 font-extrabold mt-10 border-2 border-yellow-700 w-52 p-4 mx-auto" href="/Resume_khushi_sharma.pdf" download>Download Resume</a>
                </div>
